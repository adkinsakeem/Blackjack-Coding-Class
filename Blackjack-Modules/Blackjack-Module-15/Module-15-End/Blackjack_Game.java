...
//************************************************************
		...
		play.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Opponent.currentCards.clear();
				playerSingleCards.clear();
				opponentSingleCards.clear();
				playerCardCount = 0;
				opponentCardCount = 0;
				playerText.setText(" ");
	...
	public static void calculateCurrentValue(){
		...
		if(Player.totalCardValue >= 21 || Opponent.totalCardValue == 21){
			endOfRound();
		}
	...
	public static void endOfRound(){
		...
		if (Player.totalCardValue > 21){
			opponentText.setText("Opponent has " + Opponent.totalCardValue + ". Opponent Wins");
			playerText.setText("You Busted! You have " + Player.totalCardValue);
			Opponent.score++;
		}else if(Opponent.totalCardValue > 21){
			opponentText.setText("Opponent has Busted! Opponent has " + Opponent.totalCardValue);
			playerText.setText("You have " + Player.totalCardValue + ". You Win!");
			Player.score++;
		}else if(Player.totalCardValue == Opponent.totalCardValue){
			opponentText.setText("Opponent has " + Opponent.totalCardValue + ". It is a Draw!");
			playerText.setText("You have " + Player.totalCardValue + ". It is a Draw!");
		}else if(Player.totalCardValue > Opponent.totalCardValue){
			opponentText.setText("Opponent has " + Opponent.totalCardValue + ". Opponent loses.");
			playerText.setText("You have " + Player.totalCardValue + ". You Win!");
			Player.score++;
		}else if(Player.totalCardValue < Opponent.totalCardValue){
			opponentText.setText("Opponent has " + Opponent.totalCardValue + ". Opponent Wins!");
			playerText.setText("You have " + Player.totalCardValue + ". You Lose.");
			Opponent.score++;
		}
